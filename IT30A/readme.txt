...
mysqldump -u root -p --databases lib_db > "C:\Users\Admin\Documents\kinoyog dev\IT30A\Backups\%date:~-4%_%date:~4,2%_%date:~7,2%_%time:~0,2%_%time:~3,2%_%time:~6,2%_library_db.sql"
%date:~-4%_
%date:~4,2%_
%date:~7,2%_
%time:~0,2%_
...
mysqldump -u root -p --databases lib_db > "D:\xampp\htdocs\kinoyog dev\IT30A\Backups\%date:~-4%_%date:~4,2%_%date~7,2%_%time:~0,2%_%time:~6,2%_lib_db.sql"
